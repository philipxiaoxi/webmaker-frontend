<template>
    <div>
        <div class="codes">
            <code-card headimg="https://disk.xiaotao2333.top:344/api/user/avatar/n" @click.native="goTo(item)" :id="item.id" :title="item.title" :author="item.name" v-for="item in cards" :key="item.id"></code-card>
        </div>
